...
public class GameObject {
    ...
    //1.tim trong object, neu co phan tu thoa man > reset phan tu do roi tra ra
    ...
    public static  <E extends GameObject> E findIntersects(Class<E> cls , BoxCollider collider) {
        E result = null;
        for (int i = 0; i < objects.size(); i++) {
            GameObject object = objects.get(i);
            if (object.active && object.getClass().isAssignableFrom(cls)
            && object.collider != null && object.collider.intersects(collider)){
                result = (E) object;
                break;
